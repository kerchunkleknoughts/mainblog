...
function randodreamaudio(){
  ...
  console.log("NOW DETECTING IF BGM MUSIC PLAYER IS PRESENT!!!!!!!!!!!!!!!")
  console.log(correctform.value);
  let fucky=document.createElement('div');
  fucky.innerHTML=
  `
<audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Space Ghost - New World Energy (Sunset Mix).mp3" type="audio/mpeg">
</audio>`
;
...
`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Waterfalls (3 A.M. Mix).mp3" type="audio/mpeg">
</audio>`
;
...
`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Entrance.mp3" type="audio/mpeg">
</audio>`
;
...
`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Binary Rondo.mp3" type="audio/mpeg">
</audio>`
;
...
`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Growing Sprout.mp3" type="audio/mpeg">
</audio>`
;
...
let fucky5=document.createElement('div');
fucky5.innerHTML=

`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Street Fighter 3 Third Strike_ Killing Moon Extended HD 4.mp3" type="audio/mpeg">
</audio>`
;

let fucky6=document.createElement('div');
fucky6.innerHTML=

`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/Fountains of Infinity.mp3" type="audio/mpeg">
</audio>`
;


let fucky7=document.createElement('div');
fucky7.innerHTML=

`
  <audio id="bgm" autoplay muted loop volume=0.5>
    <source src="https://kerchunkleknoughts.github.io/mainblog/resources/audio/TREASURE HUNTER.mp3" type="audio/mpeg">
</audio>`
;
...
var rando=Math.floor(Math.random() * 41);
console.log(rando);



if(rando>35){
  correctform.replaceWith(fucky7);
  }

if(rando>30){
  correctform.replaceWith(fucky6);
  }
if(rando>25){
  correctform.replaceWith(fucky5);
  }
if(rando>20){
  correctform.replaceWith(fucky4);
  }
if(rando>15){
...
function change_review_name(targetname,targettext){
...
;
  ...
  correctform.replaceWith(fucky);
   ...
   var correctform=document.getElementById("reviewtext");
  //console.log(correctform.value);
  fucky=document.createElement('div');
  fucky.innerHTML=

  `
  <div class="parentbox" id="reviewtext">
    <div class="childtextboxpadded2">
    <p>`+
    targettext
    +`
